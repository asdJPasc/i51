...
urls = ['https://www.congress.gov/search?searchResultViewType=expanded&pageSort=latestAction:desc&q={%22source%22:%22legislation%22,%22type%22:%22bills%22,%22bill-status%22:%22law%22}&pageSize=25', 
        ...
        'https://www.federalreserve.gov/supervisionreg/basel/basel-coordination-committee-bulletins.htm',
        ...
        'https://www.occ.gov/news-events/newsroom/?nr=Bulletin',
        'https://apps.occ.gov/EASearch/Search/Table?Search=&StartDateMinimum=09%2F01%2F2022&StartDateMaximum=12%2F31%2F2023&TerminationDateMinimum=&TerminationDateMaximum=&ShowIndividualActionsOnly=false&ShowInstitutionActionsOnly=true&ShowTerminatedActionsOnly=false&ShowActiveOnly=false&Category=&Sort=BankName&AutoCompleteSelection=&CurrentPageIndex=0&ItemsPerPage=10&view=Table&EnforcementTypeEnums=CivilMoneyPenaltyOrders&IsAdvanced=true',
        'https://www.fincen.gov/news-room/enforcement-actions?field_date_release_value=2022-10-01&field_date_release_value_1=2023-12-31&field_tags_financial_institution_target_id=All',
        'https://conteudo.cvm.gov.br/legislacao/index.html?numero=&lastNameShow=&lastName=&filtro=todos&dataInicio=01%2F04%2F2023&dataFim=31%2F12%2F2023&buscado=false&contCategoriasCheck=7'
       ]
